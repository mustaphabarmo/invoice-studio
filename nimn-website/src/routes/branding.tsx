...
import { defaultBranding, getBranding, loadBranding, saveBranding, type Branding } from "@/lib/invoice-store";
...
function BrandingPage() {
  ...
  async function save() { await saveBranding(brand); setSaved(true); setTimeout(() => setSaved(false), 2200); }
